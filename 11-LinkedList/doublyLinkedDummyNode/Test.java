...
public class Test {
	...
	public static void p(DoublyLinkedList l){
		if(l==null){
	...
	public static void testAdd(){
		...
		test = new DoublyLinkedList<String>();
		p("add...");
		p(test);
		test.add("a");
		p(test);
	...
	public static void testEqual(){
		...
		DoublyLinkedList<String> test = new DoublyLinkedList<String>();
		DoublyLinkedList<String> test2 = new DoublyLinkedList<String>();
		...
		p(test + " vs " + test2 + " : " + test.equals(test2));
		test.add("b");	
		test2 = new DoublyLinkedList<String>();
		p(test + " vs " + test2 + " : " + test.equals(test2));
		test2.add("a");	
		p(test + " vs " + test2 + " : " + test.equals(test2));
		test2.add("b");	
